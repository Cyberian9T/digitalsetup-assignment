        ...
        <section id='projects' className="p-5 overflow-hidden">
            <div className="container mt-5 mb-5">
                <div className="d-flex justify-content-center m-5">
                    <p className="fs-60">our <span className='text-primary'>projects</span></p>
                </div>
                <div className="d-flex justify-content-evenly">
                    <div className="cardshadow m-3" >
                        <img src="/Sansiri.png" className="card-img-top" alt="..." width={407} height={232} />
                    ...
                    <div className="cardshadow m-3" >
                        <img src="/Bentagro.png" className="card-img-top" alt="..." width={407} height={232} />
                        <div className="card-body p-3">
                    ...
                    <div className="cardshadow m-3" >
                        <img src="/Mercedes Benz.png" className="card-img-top" alt="..." width={407} height={232} />
                        <div className="card-body p-3">
